    ...
    return (
        <div className='py-16 px-4 md:px-8'>
            <div className='max-w-7xl mx-auto'>
                <div className='bg-gradient-to-r from-primary to-secondary rounded-3xl overflow-hidden shadow-hero fade-in-up'>
                    <div className='flex flex-col md:flex-row items-center p-8 md:p-12 lg:p-16'>
                        <div className='md:w-1/2 mb-8 md:mb-0 md:pr-8'>
                            ...
                            <p className='text-white/90 text-lg mb-6'>
                                Join thousands of satisfied customers who trust BookMyService for all their home service needs. 
